...
% MPC Parameters
dt = sys.parameters.dt; % Sampling time from system parameters
% dt = 0.1; % TODO: Decide whether to store dt as a system parameter
...
x = sys.parameters.x_ini; % Initial state from system definition
